...
Plugin URI: https://wordpress.org/plugins/auto-post-to-ig/
Description: Plugin for automatic posting Wordpress images to Photo Social Network
Author: Roland & Informatica Duran
Version: 1.5.5
Author URI: https://wordpress.org/plugins/auto-post-to-ig/
*/
...
define('WP2INSTAGRAM_VERSION', '1.5.4');
    ...
    class wp2instagram
    {
        public function wp2instagram_plugin_meta_links($wp2instagram_meta_links, $wp2instagram_file)
        {
            if ($wp2instagram_file == WP2INSTAGRAM_PLUGIN_BASE) {
                $wp2instagram_meta_links[] = '<a href="https://wordpress.org/support/plugin/auto-post-to-ig">Support forum</a>';
                $wp2instagram_meta_links[] = '<a href="http://wordpress.org/extend/plugins/auto-post-to-ig/faq">FAQ</a>';
            }
